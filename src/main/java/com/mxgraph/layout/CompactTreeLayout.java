...
public class CompactTreeLayout extends GraphLayout
{
	 ...
	 * @param graph
	 */
	public CompactTreeLayout(JGraphX graph)
	{
		this(graph, true);
	}
	 ...
	 * @param horizontal
	 */
	public CompactTreeLayout(JGraphX graph, boolean horizontal)
	{
	 ...
	 * @param invert
	 */
	public CompactTreeLayout(JGraphX graph, boolean horizontal, boolean invert)
	{
		super(graph);

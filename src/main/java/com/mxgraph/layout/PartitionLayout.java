...
public class PartitionLayout extends GraphLayout
{
	 ...
	 */
	public PartitionLayout(JGraphX graph)
	{
		this(graph, true);
	}
	 ...
	 * spacing, orientation and offset.
	 */
	public PartitionLayout(JGraphX graph, boolean horizontal)
	{
	 ...
	 * spacing, orientation and offset.
	 */
	public PartitionLayout(JGraphX graph, boolean horizontal, int spacing)
	{

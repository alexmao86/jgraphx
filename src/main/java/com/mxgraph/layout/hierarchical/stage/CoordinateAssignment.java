...
import com.mxgraph.layout.hierarchical.model.GraphAbstractHierarchyCell;
...
import com.mxgraph.layout.hierarchical.model.GraphHierarchyRank;
...
public class CoordinateAssignment implements HierarchicalLayoutStage
{
	 ...
	 *            an internal model of the hierarchical layout
	 */
	private void initialCoords(JGraphX facade, GraphHierarchyModel model)
	{
	 ...
	 *            an internal model of the hierarchical layout
	 */
	protected void setCellLocations(JGraphX graph, GraphHierarchyModel model)
	{

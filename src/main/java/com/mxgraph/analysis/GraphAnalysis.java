...
public class GraphAnalysis
{
	 ...
	 */
	public Object[] getShortestPath(JGraphX graph, Object from, Object to,
	 ...
	 * @see #createPriorityQueue()
	 */
	public Object[] getMinimumSpanningTree(JGraphX graph, Object[] v,
	 ...
	 * 
	 * @see #getMinimumSpanningTree(JGraphX, Object[], ICostFunction,
	 *      boolean)
	 * 
			...
			Object[] e, ICostFunction cf)
	{
		...
		JGraphXCellState[] edgeStates = sort(view.getCellStates(e), cf);
	 ...
	 * @see #createUnionFind(Object[])
	 */
	public mxUnionFind getConnectionComponents(JGraphX graph, Object[] v,
			Object[] e)
	{
		GraphView view = graph.getView();
		mxUnionFind uf = createUnionFind(v);
		...
		for (int i = 0; i < e.length; i++)
		{
			JGraphXCellState state = view.getState(e[i]);
	 ...
	 *         <code>cf</code>
	 */
	public JGraphXCellState[] sort(JGraphXCellState[] states, final ICostFunction cf)
	{
		List<JGraphXCellState> result = Arrays.asList(states);

		Collections.sort(result, new Comparator<JGraphXCellState>()
		{

			/**
			 * 
			 */
			public int compare(JGraphXCellState o1, JGraphXCellState o2)
			{
		...
		return (JGraphXCellState[]) result.toArray();
	}
	 ...
	 */
	public double sum(JGraphXCellState[] states, ICostFunction cf)
	{
		double sum = 0;

 ...
 */
public class JGraphXCellState extends mxRectangle
{
	/**
	 * 
	 */
	 ...
	 */
	protected JGraphXCellState visibleSourceState, visibleTargetState;

	/**
	 * Constructs an empty cell state.
	 */
	public JGraphXCellState()
	{
		this(null, null, null);
	}
	 ...
	 */
	public JGraphXCellState(GraphView view, Object cell, Map<String, Object> style)
	{
		setView(view);
		setCell(cell);
		setStyle(style);
	...
	{
		JGraphXCellState tmp = getVisibleTerminalState(source);
	 ...
	 * returned.
	 */
	public JGraphXCellState getVisibleTerminalState(boolean source)
	{
	 ...
	 */
	public void setVisibleTerminalState(JGraphXCellState terminalState,
										boolean source)
	{
		if (source)
		{
	...
	public Object clone()
	{
		JGraphXCellState clone = new JGraphXCellState(view, cell, style);

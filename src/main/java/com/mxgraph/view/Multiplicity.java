...
public class Multiplicity
{
	 ...
	 */
	public String check(JGraphX graph, Object edge, Object source,
	 ...
	 * Checks the type of the given value.
	 */
	public boolean checkTerminal(JGraphX graph, Object terminal, Object edge)
	{
	 ...
	 * Checks the type of the given value.
	 */
	public boolean checkType(JGraphX graph, Object value, String type)
	{
			...
			String attr, String attrValue)
	{
		if (value != null)
		{
			...
			{
				return JGraphXUtils.isNode(value, type, attr, attrValue);
			}
			else
			{

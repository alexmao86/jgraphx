...
public class Perimeter
{
	...
	public interface mxPerimeterFunction
	{
		 ...
		 */
		mxPoint apply(mxRectangle bounds, JGraphXCellState vertex, mxPoint next,
                      boolean orthogonal);
	...
	public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction()
	{
		 ...
		 */
		public mxPoint apply(mxRectangle bounds, JGraphXCellState vertex,
	...
	public static mxPerimeterFunction RhombusPerimeter = new mxPerimeterFunction()
	{
				...
				mxPoint next, boolean orthogonal)
		{
			...
			if (px < cx)
			{
				if (py < cy)
				{
					return JGraphXUtils.intersection(px, py, tx, ty, cx, y, x, cy);
				}
				else
				{
					return JGraphXUtils.intersection(px, py, tx, ty, cx, y + h, x,
							cy);
				}
			}
			else if (py < cy)
			{
				return JGraphXUtils.intersection(px, py, tx, ty, cx, y, x + w, cy);
			}
			else
			{
				return JGraphXUtils.intersection(px, py, tx, ty, cx, y + h, x + w,
						cy);
			}
		}
	...
	public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction()
	{
		...
		public mxPoint apply(mxRectangle bounds, JGraphXCellState vertex,
				mxPoint next, boolean orthogonal)
		{
			Object direction = (vertex != null) ? JGraphXUtils.getString(
			...
			else
			{
				...
				{
					result = JGraphXUtils.intersection(next.getX(), next.getY(), cx,
	...
	public static mxPerimeterFunction HexagonPerimeter = new mxPerimeterFunction()
	{
				...
				mxPoint next, boolean orthogonal)
		{
			...
			if (orthogonal)
			{
				...
				result = JGraphXUtils.intersection(tx, ty, next.getX(), next.getY(),
			...
			else
			{
				...
				result = JGraphXUtils.intersection(cx, cy, next.getX(), next.getY(),
						a.getX(), a.getY(), b.getX(), b.getY());
			}
			if (result == null)
			{

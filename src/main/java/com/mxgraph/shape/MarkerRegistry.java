...
public class MarkerRegistry
{
	...
	static
	{
		...
		registerMarker(mxConstants.ARROW_OPEN, new IMarker()
		{
			public mxPoint paintMarker(Graphics2DCanvas canvas,
                                       JGraphXCellState state, String type, mxPoint pe, double nx,
                                       double ny, double size, boolean source)
		...
		registerMarker(mxConstants.ARROW_OVAL, new IMarker()
		{
			public mxPoint paintMarker(Graphics2DCanvas canvas,
                                       JGraphXCellState state, String type, mxPoint pe, double nx,
                                       double ny, double size, boolean source)
		...
		registerMarker(mxConstants.ARROW_DIAMOND, new IMarker()
		{
			public mxPoint paintMarker(Graphics2DCanvas canvas,
                                       JGraphXCellState state, String type, mxPoint pe, double nx,
                                       double ny, double size, boolean source)

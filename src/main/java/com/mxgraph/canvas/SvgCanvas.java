...
public class SvgCanvas extends BasicCanvas
{
	...
	public Object drawCell(JGraphXCellState state)
	{
		...
		if (state.getAbsolutePointCount() > 1)
		{
			...
			pts = JGraphXUtils.translatePoints(pts, translate.getX(), translate.getY());
			...
			float opacity = JGraphXUtils.getFloat(style, mxConstants.STYLE_OPACITY,
					100);
			float fillOpacity = JGraphXUtils.getFloat(style, mxConstants.STYLE_FILL_OPACITY,
					100);
			float strokeOpacity = JGraphXUtils.getFloat(style, mxConstants.STYLE_STROKE_OPACITY,
					100);
		...
		else
		{
			...
			{
				int start = (int) Math.round(JGraphXUtils.getInt(style,
			...
			Map<String, Object> style)
	{
		...
		float opacity = JGraphXUtils.getFloat(style, mxConstants.STYLE_OPACITY, 100);
		float fillOpacity = JGraphXUtils.getFloat(style, mxConstants.STYLE_FILL_OPACITY, 100);
		float strokeOpacity = JGraphXUtils.getFloat(style, mxConstants.STYLE_STROKE_OPACITY, 100);

		// Draws the shape
		String shape = JGraphXUtils.getString(style, mxConstants.STYLE_SHAPE, "");
		Element elem = null;
		...
		if (shape.equals(mxConstants.SHAPE_IMAGE))
		{
			...
			if (img != null)
			{
				...
				boolean flipH = JGraphXUtils.isTrue(style,
						mxConstants.STYLE_IMAGE_FLIPH, false);
				boolean flipV = JGraphXUtils.isTrue(style,
			...
			if (shape.equals(mxConstants.SHAPE_LABEL))
			{
				...
				if (img != null)
				{
					...
					int imgHeight = (int) (JGraphXUtils.getInt(style,
							...
							mxConstants.DEFAULT_IMAGESIZE) * scale);
					int spacing = (int) (JGraphXUtils.getInt(style,
				...
				if (JGraphXUtils.isTrue(style, mxConstants.STYLE_GLASS, false))
				{
					double size = 0.4;
		...
		if (JGraphXUtils.isTrue(style, mxConstants.STYLE_DASHED))
		{
			String pattern = JGraphXUtils.getString(style, mxConstants.STYLE_DASH_PATTERN, "3, 3");
	...
	public Element drawLine(List<mxPoint> pts, Map<String, Object> style)
	{
		...
		boolean rounded = JGraphXUtils.isTrue(style, mxConstants.STYLE_ROUNDED,
				false);
		String strokeColor = JGraphXUtils.getString(style,
				mxConstants.STYLE_STROKECOLOR);
		float tmpStroke = (JGraphXUtils.getFloat(style,
	...
	{
		Element elem = null;
		String fontColor = JGraphXUtils.getString(style,
				mxConstants.STYLE_FONTCOLOR, "black");
		String fontFamily = JGraphXUtils.getString(style,
				mxConstants.STYLE_FONTFAMILY, mxConstants.DEFAULT_FONTFAMILIES);
		int fontSize = (int) (JGraphXUtils.getInt(style, mxConstants.STYLE_FONTSIZE,
		...
		if (text != null && text.length() > 0)
		{
			...
			String bg = JGraphXUtils.getString(style,
					mxConstants.STYLE_LABEL_BACKGROUNDCOLOR);
			String border = JGraphXUtils.getString(style,
			...
			int fontStyle = JGraphXUtils.getInt(style, mxConstants.STYLE_FONTSTYLE);
			...
			String align = JGraphXUtils.getString(style, mxConstants.STYLE_ALIGN,

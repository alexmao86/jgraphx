...
public class VmlCanvas extends BasicCanvas
{
	...
	public Object drawCell(JGraphXCellState state)
	{
		...
		if (state.getAbsolutePointCount() > 1)
		{
			...
			// Draws the markers
			String start = JGraphXUtils.getString(style,
					mxConstants.STYLE_STARTARROW);
			String end = JGraphXUtils.getString(style, mxConstants.STYLE_ENDARROW);
			...
			if (start != null || end != null)
			{
				if (start != null)
				{
					...
					double startSize = JGraphXUtils.getFloat(style,
				...
				if (end != null)
				{
					...
					double endSize = JGraphXUtils.getFloat(style,
	...
	public Element drawText(String text, int x, int y, int w, int h,
			Map<String, Object> style)
	{
		Element table = JGraphXUtils.createTable(document, text, x, y, w, h, scale,
				style);

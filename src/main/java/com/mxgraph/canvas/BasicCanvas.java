...
public abstract class BasicCanvas implements IJGraphXCanvas
{
	...
	public BufferedImage loadImage(String image)
	{
		...
		if (img == null)
		{
			img = JGraphXUtils.loadImage(image);
	...
	{
		String filename = JGraphXUtils.getString(style, mxConstants.STYLE_IMAGE);

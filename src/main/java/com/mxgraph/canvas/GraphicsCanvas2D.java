...
public class GraphicsCanvas2D implements ICanvas2D
{
	...
	public void setDashPattern(String value)
	{
		...
		{
			state.dashPattern = JGraphXUtils.parseDashPattern(value);
		}
	}
	...
	/**
	 * Helper method that uses {@link JGraphXUtils#parseColor(String)}.
	 */
	...
	protected Color parseColor(String hex, double alpha)
	{
		...
		if (result == null)
		{
			result = JGraphXUtils.parseColor(hex, alpha);
	...
	{
		return JGraphXUtils.loadImage(src);
	}

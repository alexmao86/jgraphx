...
import com.mxgraph.swing.view.CellStatePreview;
...
public class Morphing extends Animation
{
	 ...
	 */
	public Morphing(JGraphXComponent graphComponent)
	{
	 ...
	 * Constructs a new morphing instance for the given graph.
	 */
	public Morphing(JGraphXComponent graphComponent, int steps, double ease,
					int delay)
	{
		super(delay);

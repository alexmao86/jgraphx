 ...
 */
public class JGraphXRubberband implements MouseListener, MouseMotionListener
{
	 ...
	 */
	public JGraphXRubberband(final JGraphXComponent graphComponent)
	{
	...
	public void paintRubberband(Graphics g)
	{
				...
				&& graphComponent.isSignificant(bounds.width, bounds.height))
		{
			...
			JGraphXUtils.fillClippedRect(g, rect.x, rect.y, rect.width, rect.height);
